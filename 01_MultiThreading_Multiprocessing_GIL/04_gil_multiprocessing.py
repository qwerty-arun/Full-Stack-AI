...
# without the main function, we will get RunTimeError
# An attemp has been made to start a new process before the current process has finished its bootstrapping phase
