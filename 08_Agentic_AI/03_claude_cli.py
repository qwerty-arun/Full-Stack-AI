...
SYSTEM_PROMPT = """
    ...
    Available Tools:
    - get_weather(city: str): Takes city name as an input string and returns the weatther info about the city.
...
while True:
    ...
    while True:
        ...
        if parsed_result.step == 'OUTPUT':
            print("🎂", parsed_result.content.encode().decode("unicode_escape"))
            break
